...
export type TranslateMutation = { translate: { translation: { text: string, notes: string | null, furigana: string | null, sourceLanguage: Language, targetLanguage: Language } | null, errors: Array<{ code: TranslateErrorCode, message: string, retryable: boolean, retryAfterSeconds: number | null }> } };
